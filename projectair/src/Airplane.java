public class Airplane {
    ...
    public String getPlaneFacturer() { return planeFacturer; }
    public int getPlaneCapacity() { return planeCapacity; }
    public boolean getPlaneAvailability() { return planeAvailability; }
    
    public void setPlaneModel(String planeModel) { this.planeModel = planeModel; }
    public void setPlaneFacturer(String planeFacturer) { this.planeFacturer = planeFacturer; }
    public void setPlaneCapacity(int planeCapacity) { this.planeCapacity = planeCapacity; }
    public void setPlaneAvailability(boolean planeAvailability) { this.planeAvailability = planeAvailability; }
}
